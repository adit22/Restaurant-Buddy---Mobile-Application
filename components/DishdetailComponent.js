    ...
    if(dish!=null){
        return(
            ...
            >
                ...
                raised
                reverse
                name={props.favourites?'heart':'heart-o'}
                type='font-awesome'
                color='#f50'
                onPress={()=>props.favourites ? console.log('Already favourite'):props.onPress()}
                />
...
class Dishdetail extends Component{
    ...
    render(){
        ...
        favourites={this.state.favourites.some(el=>el=== dishId)}
